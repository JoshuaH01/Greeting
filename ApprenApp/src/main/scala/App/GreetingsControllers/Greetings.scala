...
import App.Models.{BankAccount, CashISASavingsAccount, Person}
    ...
    val personWithCashISA2 = new CashISASavingsAccount
    ("12345678", 0.00, depositThreshhold = 1000.00).deposit(1000.00).withdraw(300.00)
    ...
    val p: Person = new Person(name, age)
